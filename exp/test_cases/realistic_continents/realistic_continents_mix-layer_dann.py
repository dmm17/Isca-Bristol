...
exp = Experiment('realistic_continents_mixed-layer_test_experiment4', codebase=cb)

#Add any input files that are necessary for a particular experiment.
exp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/land_eye_final.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'),
...
namelist_name = os.path.join(GFDL_BASE, 'exp/test_cases/realistic_continents/namelist_basefile_dann.nml')
...
#Set Jupiter constants
        'radius':  3500.0e3,
        'grav':  26.0,
        'omega':  2.908e-4, #4 planet days per 1 earth day
...
if __name__=="__main__":
    ...
    for i in range(2,500): #this causes it to delibrately crash because it cant find the restart, good for testing
