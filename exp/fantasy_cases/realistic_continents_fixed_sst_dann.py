...
exp = Experiment('realistic_continents_mixed-layer_test_experiment', codebase=cb)
...
namelist_name = os.path.join(GFDL_BASE, 'exp/fantasy_cases/namelist_basefile.nml')
