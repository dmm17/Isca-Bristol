...
def write_land(exp,land_mode='square',boundaries=[-20.,20.,140.,220.],continents=['all'],topo_mode='gaussian',mountains=['all'],topo_gauss=[0.,180.,10.,5.,3500.],waterworld=False):
#def write_land(exp,boundaries=[-20.,20.,0.,40.],topo_mode='gaussian',mountains=['all'],topo_gauss=[0.,20.,10.,5.,3500.],waterworld=False):
...
# Common features of set-ups
    ...
    print(GFDL_BASE + '/src/extra/python/scripts/gfdl_grid_files/t'+str(t_res)+'.nc')
...
# Next produce a topography array
    ...
    topo_filename = GFDL_BASE + 'input/land_masks/land_eye2.nc'
...
if __name__ == "__main__":
    ...
    write_land('test',land_mode='square',boundaries=[20.,60.,220.,260.],continents=['all'],topo_mode='gaussian',mountains=['all'],topo_gauss=[40.,240.,10.,5.,2000.],waterworld=False)
